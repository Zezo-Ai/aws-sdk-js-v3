...
export var InvokeEndpoint$: StaticOperationSchema = [9, n0, _IE,
  { [_h]: ["POST", "/endpoints/{EndpointName}/invocations", 200] }, () => InvokeEndpointInput$, () => InvokeEndpointOutput$
];
export var InvokeEndpointAsync$: StaticOperationSchema = [9, n0, _IEA,
  { [_h]: ["POST", "/endpoints/{EndpointName}/async-invocations", 202] }, () => InvokeEndpointAsyncInput$, () => InvokeEndpointAsyncOutput$
];
export var InvokeEndpointWithResponseStream$: StaticOperationSchema = [9, n0, _IEWRS,
